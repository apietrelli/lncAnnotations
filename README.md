...
flat2Cdf("hugene20st_Hs_GENECODET.flat", chipType="Gene2.0st.lncrna.ENSG", tag="v21", col.class=c("character","integer","integer","character","character","character"), rows=1612, cols= 1612, xynames=c("X","Y"), ucol=5, gcol=6)
